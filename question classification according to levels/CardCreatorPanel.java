...
public class CardCreatorPanel extends JPanel{
    ...
    //for text areas
    public static final int TEXT_AREA_HEIGHT = 60;
    ...
    //new
    private String[] levels = { "Beginner", "Normal", "Expert" };

//Create the combo box, select item at index 4.
//Indices start at 0, so 4 specifies the pig.
    private final JComboBox levelList = new JComboBox(levels);
    ...
    class cardListener implements ActionListener{
        public void actionPerformed(ActionEvent e){
            ...
            if(picture.equals("") == false){
                ...
                controller.addCardToActiveProject(new Card(question,answer,picture,level));
            }
            else{
                //no picture
                controller.addCardToActiveProject(new Card(question,answer,level));
            }    
