...
public class Session extends Object{
    ...
    public Session(Project project){
        ...
        project.setSession(this,this.level);

        cards = new ArrayList<Card>();
        setupSession(project.getCards());
    }
    
    public int getLevelCards()
    {
        Card temp;
       int levelCards = 0;
       for(int i = 0; i < numCards(); i++)
       {
           if(cards.get(i).getLevel().equals(this.project.level))
               levelCards++;
       }
       return levelCards;
    }
    ...
    public void end(){
        ...
        project.setSession(null,"Beginner");
    }
    ...
    public Card getCard(){
        ...
        while(!found)
        {
            ...
            String currentLevel = currentCard.getLevel();    
            if(currentLevel.equals(this.project.getLevel()))
            {
                cardNum++;
                return currentCard;
            }
