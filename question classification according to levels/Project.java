...
public class Project implements Comparable<Project>{
    ...
    /* SESSION STUFF */
    public void setSession(Session session,String level){
     ...
     * 
     */
    public void newSession(String level){
        do{
            setSession(new Session(this),level);
        }
    ...
    public Card nextCard(String level){
        return deck.getCard(level);
    }
