...
public class Card extends Object{
    ...
    public Card(Status status, int sessionsLeft, String question, String answer, String pictureName, String level){
        setStatus(status);
    ...
    public Card(Status status,String question,String answer,String pictureName,String level){
        this(status,status.getReps(),question,answer,pictureName,level);
    }
    
    public Card(String question,String answer,String pictureName,String level){
        this(Status.DEFAULT_STATUS,question,answer,pictureName,level);
    }
    
    public Card(String question,String answer,String level){
        this(question,answer,NO_PICTURE_STRING,level);
    }
