...
public class StudyPanel extends JPanel{
    ...
    public static final int MY_HEIGHT = 395;
            ...
            private JComboBox levelList = new JComboBox(levels);
            //
    ...
    private void decideOnLabelUpdate(){
        ...
        int current = getSession().cardNum + 0;
        int total = getSession().getLevelCards();
     ...
     * 
     */
    private void newSession(String level){
        getProject().newSession(level);
        //update bar graph
