...
public final class Controller extends Object{
     ...
     */
    private ArrayList<Project> loadProjectsFromFile() throws FileNotFoundException{
     ...
     */
    public void createProjectFromExistingFile(String projectName,File projectFolder) throws FileNotFoundException{
        Project project = new Project(projectName);
