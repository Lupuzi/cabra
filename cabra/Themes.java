...
public enum Themes{
    ...
    HAKUNA_MATATA("Hakuna Matata","hakuna_matata.png", Rank._02_STUDENT){
        @Override
                public void doColoring(){
                    resetDefaults();
                    UIManager.put("control",ColorManager.createColor("F9CB98"));
                    UIManager.put("nimbusBase",ColorManager.createColor("FF9966"));
                    UIManager.put("nimbusDisabledText",ColorManager.createColor("F9CB98"));
                    UIManager.put("nimbusFocus",ColorManager.createColor("FF6666"));
                }
    }, 
    ...
    SPONGEBOB("Sponge Bob","spongebob.png",Rank._04_AMATEUR){
        @Override
                public void doColoring(){
                    resetDefaults();
                    UIManager.put("control",ColorManager.createColor("FFFF99"));
                    UIManager.put("nimbusBase",ColorManager.createColor("FF9966"));//B53056
                    UIManager.put("nimbusDisabledText",ColorManager.createColor("51343E"));
                    UIManager.put("nimbusFocus",ColorManager.createColor("FFFF99"));//FFA8C6
                }
    },  
    /** A smoky but brilliant theme with reds and oranges
     * 
     */
    DUSK("Dusk","dusk.png", Rank._01_KID){
        @Override
                public void doColoring(){
                    resetDefaults();
